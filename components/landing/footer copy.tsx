      ...
      <div className={cn("rounded-[32px] glass-dark px-6 py-20 sm:p-10")}>
        <div className="grid gap-10 lg:grid-cols-3 lg:items-start">
          ...
          <div className="space-y-3">
            ...
            <div className="mt-6 rounded-[28px] border border-yellow-500/15 bg-black/40 p-4 backdrop-blur-xl">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-1 inline-block text-sm font-semibold text-yellow-500 hover:opacity-90"
              >
            ...
            <div className="grid grid-cols-2 gap-2">
              {LINKS.map((l) => (
                <a
                  key={l.href}
                  href={l.href}
                  className="rounded-2xl border border-yellow-500/12 bg-black/35 px-4 py-3 text-sm text-white/80 backdrop-blur-xl transition hover:bg-black/45"
                >
